...
class MapWindow:
    ...
    def draw_box(self):
        ...
        legend_x_start = 10
        legend_y_start = 10
        legend_width = legend_x_start + 150
        ...
        self.canvas.create_text(legend_x_start + 16, legend_y_start + 9, text=f"Point1: {self.point1}", anchor="w")
        self.canvas.create_oval(legend_x_start + 6, legend_y_start + 22, legend_x_start + 12, legend_y_start + 28, outline="blue", fill="blue")
        self.canvas.create_text(legend_x_start + 16, legend_y_start + 25, text=f"Point2: {self.point2}", anchor="w")

...
DB_Addr_sump = tk.StringVar()
Source_sump = tk.StringVar()
...
db_addr_sump_value = DB_Addr_sump.get()
...
spill_level = 90#5percent of data must be above
...
start_date_spill_query = '2023-01-01'
